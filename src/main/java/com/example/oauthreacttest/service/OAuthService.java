...
import com.example.oauthreacttest.domain.OAuthAttributes;
import com.example.oauthreacttest.domain.UserProfile;
...
public class OAuthService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
	...
	private Member saveOrUpdate(UserProfile userProfile) {
		System.out.println("UserProfile="+userProfile.getImageUrl());
